...
class DrinkRecipePage extends StatefulWidget {
  ...
  DrinkRecipePage(this.onRecipeTap);
  ...
  void initState() {
    tabsBody = List.filled(
        ...
        ListView(
          children: [
            DHDishCard(
                dish: Dish(id: 17, image: dishes[4], title: titles[4]),
                onTap: widget.onRecipeTap),
            DHDishCard(
                dish: Dish(id: 18, image: dishes[5], title: titles[5]),
                onTap: widget.onRecipeTap),
            DHDishCard(
                dish: Dish(id: 19, image: dishes[4], title: titles[4]),
                onTap: widget.onRecipeTap),
            DHDishCard(
                dish: Dish(id: 20, image: dishes[5], title: titles[5]),
                onTap: widget.onRecipeTap),
          ],
        ));
    super.initState();
